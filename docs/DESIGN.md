# I Dream. AI Works. — DESIGN

這份文件定義 idreamaiworks.com 的視覺方向與設計系統。
氣質參考 **Dieter Rams**（Braun / Vitsœ）。這是氣質與系統參考，不是複製任何外部品牌資產。
（與 aileanstartup.com / thesuperone.com 共用同一套設計系統 token。）

---

## 產品本質

idreamaiworks.com 不是 landing page，而是**一本公開寫作中的書**（系列母世界觀）。
所以設計目標不是「轉換」，而是：
